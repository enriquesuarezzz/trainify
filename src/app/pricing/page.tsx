    ...
    <section className="container py-16 text-center">
      ...
      <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
        {plans.map((plan, index) => (
          <div
            key={index}
            className={`relative flex flex-col rounded-xl border p-6 shadow-md transition duration-300 ${
              plan.isPopular
                ? 'z-10 scale-105 border-orange-500 bg-white hover:scale-110'
          ...
          >
            ...
            {/* Features */}
            <ul className="mb-6 list-none space-y-2 text-left">
